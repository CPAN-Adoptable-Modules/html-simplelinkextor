...
CPAN web interfaces, such as L<CPAN Search|http://search.cpan.org/dist/HTML-SimpleLinkExtor> or 
L<MetaCPAN|http://www.metacpan.org/module/HTML::SimpleLinkExtor>:

=over 4

=item *	L<http://search.cpan.org/dist/HTML-SimpleLinkExtor>

=item *	L<http://www.metacpan.org/module/HTML::SimpleLinkExtor>
